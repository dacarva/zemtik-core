...
pub struct EvidencePack {
    ...
    /// Human-readable compliance narrative auto-generated by the engine.
    /// Describes what computation ran, what data stayed local, and how to verify.
    /// Empty string for pre-v3 packs deserialized from historical JSON.
    #[serde(default)]
    pub human_summary: String,
    /// Ordered list of cryptographic and policy checks performed.
    /// Each entry is a machine-stable identifier (e.g. "intent_classification").
